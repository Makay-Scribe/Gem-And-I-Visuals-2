...
// --- NEW: Import all our new GLSL files as raw text strings ---
...
export const ComputeManager = {
    ...
    init(appInstance, planeWidth, planeHeight, planeResX, planeResY) {
        ...
        // --- THE FIX IS HERE: All ShaderChunk keys are now prefixed with 'gpgpu_' ---
        ...
        // Create the compute variables using the new main shader file
